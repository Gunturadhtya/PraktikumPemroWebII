            ...
            <div class="bg-white max-w-xl mx-auto overflow-hidden shadow-sm sm:rounded-lg p-6 sm:p-8">
                <form method="POST" action="{{ route('buku.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="judul_buku" class="block mt-1 w-full" type="text" name="judul_buku" :value="old('judul_buku')" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="tahun_terbit" class="block mt-1 w-full" type="number" name="tahun_terbit" :value="old('tahun_terbit')" placeholder="e.g. 2012" required />
