...
<div class="container mt-5 bg-form">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h3 class="text-center mb-4 text-dark">Form Penambahan Member<br>Perpustakaan Guntur</h3>
            
            <form method="POST">
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary" style="font-size: 0.9rem;">Nama Member:</label>
                    <input type="text" name="nama_member" class="form-control bg-light border-0 py-2" required>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary" style="font-size: 0.9rem;">Nomor Member:</label>
                    <input type="text" name="nomor_member" class="form-control bg-light border-0 py-2" required>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary" style="font-size: 0.9rem;">Alamat:</label>
                    <textarea name="alamat" class="form-control bg-light border-0 py-2" rows="3"></textarea>
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold text-secondary" style="font-size: 0.9rem;">Tgl Mendaftar:</label>
                    <input type="datetime-local" name="tgl_mendaftar" class="form-control bg-light border-0 py-2" required>
                </div>
                
                <div class="mb-4">
                    <label class="form-label fw-bold text-secondary" style="font-size: 0.9rem;">Tgl Terakhir Bayar:</label>
                    <input type="date" name="tgl_terakhir_bayar" class="form-control bg-light border-0 py-2">
                </div>
